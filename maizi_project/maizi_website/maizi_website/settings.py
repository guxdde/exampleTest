...
INSTALLED_APPS = (
    ...
    'maizi_website.apps.common',
    'maizi_website.apps.course',
    'maizi_website.apps.users',
)
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'maizi_website.utils.context_processors.maizi',
            ],
        },
    },
]
...
SITE_NAME = '麦子学院'
META_KEYWORDS = '在线学习，课程'
META_DESCRIPTION = '互联网在线IT技术学习网站'